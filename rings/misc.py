...
class Misc(commands.Cog):
    ...
    @guild_only(496617962334060545)
    @commands.check_any(commands.has_role(497009979857960963), has_perms(6)) #Admin
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        if self.bot.get_guild(payload.guild_id).get_member(payload.user_id).get_role(497009979857960963) is not None:
            return
