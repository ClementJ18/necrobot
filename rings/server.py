...
class Server(commands.Cog):
    ...
    async def starboard_stars(self, ctx, user : discord.Member = None):
        """
        See all the starred messages of a user or just all the ones on the server
        ...
        await react_menu(ctx, stars, 10, embed_maker)
